...
//#region node_modules/.pnpm/sonner@2.0.8_@types+react@1_6de7824c00f48252fba10541e16b4c5e/node_modules/sonner/dist/index.mjs
...
var Observer = class {
	constructor() {
		this.subscribe = (subscriber) => {
			...
			this.getActiveToasts().forEach((toast$1) => subscriber(toast$1));
			return () => {
		...
		this.trimHistory = () => {
			...
			this.toasts = this.toasts.filter((toast$1) => {
				if (toRemove > 0 && this.dismissedToasts.has(toast$1.id)) {
					this.dismissedToasts.delete(toast$1.id);
					toRemove--;
					return false;
				}
				return true;
		...
		this.create = (data) => {
			...
			if (wasDismissed) {
				this.dismissedToasts.delete(id);
				this.toasts = this.toasts.filter((toast$1) => toast$1.id !== id);
			}
			if (wasDismissed ? void 0 : this.toasts.find((toast$1) => {
		...
		this.dismiss = (id) => {
			if (id === void 0 || id === null) {
				this.getActiveToasts().forEach((toast$1) => {
					this.dismissedToasts.add(toast$1.id);
...
var Toast = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("li", {
		tabIndex: 0,
		ref: toastRef,
		className: cn(className, toastClassname, classNames == null ? void 0 : classNames.toast, toast$1 == null ? void 0 : (_toast_classNames = toast$1.classNames) == null ? void 0 : _toast_classNames.toast, classNames == null ? void 0 : classNames[toastTypeKey], toast$1 == null ? void 0 : (_toast_classNames1 = toast$1.classNames) == null ? void 0 : _toast_classNames1[toastTypeKey]),
		"data-sonner-toast": "",
	...
	}, toastType === "loading" ? toast$1.icon || getLoadingIcon() : toast$1.promise ? getLoadingIcon() : null, toastType !== "loading" ? icon : null) : null, /* @__PURE__ */ import_react.createElement("div", {
		"data-content": "",
